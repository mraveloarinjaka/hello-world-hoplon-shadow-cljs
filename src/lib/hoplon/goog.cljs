...
;goog.events.EventType keys are changed under advanced compilation
;smilar to jquery implementaion we just assume that the client pass the correct event
;{
  ;"tg": "click",
  ;"zi": "rightclick",
  ;"Dg": "dblclick",
...
(defmethod on! :hoplon.core/default
  [elem event callback]
  (js/console.dir events/EventType)
